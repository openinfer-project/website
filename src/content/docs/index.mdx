...
# Starlight renders the homepage <title> as "openinfer | openinfer"
...
head:
  - tag: title
    content: "openinfer — Pure Rust + CUDA LLM Inference Engine"
  - tag: meta
    attrs:
      property: og:title
      content: "openinfer — Pure Rust + CUDA LLM Inference Engine"
...
| [Qwen3.5-4B / 9B / 27B](/models/qwen35-4b/) | Hybrid: 3:1 linear + full attention layers |
